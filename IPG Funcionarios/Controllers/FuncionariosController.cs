...
namespace IPG_Funcionarios.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(ProfessoresDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FuncionariosId,Nome,Telemovel,Telefone,Email,Horas_de_trabalho")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FuncionariosId,Nome,Telemovel,Telefone,Email,Horas_de_trabalho")] Funcionarios funcionarios)
        {
